        ...
        <vuescroll :ops="ops">
          <div class="grid gap-4 p-8 grid-switcher">
            <div
              ...
              :index="index"
            >
              <div class="flex items-center justify-between hidden mb-8 sm:block">
                <div class="flex items-center">
                  <h2
                    class="text-xl font-bold leading-tight text-gray-700"
                  >{{ getMuscleGroup(id) }} Exercises</h2>
                </div>
              </div>
              <div
                ...
                <div>
                  <span
                    ...
                    :class="
                      `bg-${getMuscleColor(
                        exercise.muscle_id
                      )}-100 text-${getMuscleColor(exercise.muscle_id)}-800`
                    "
                  >{{ getMuscleGroup(exercise.muscle_id) }}</span>
                </div>
                <div>
                  <button
