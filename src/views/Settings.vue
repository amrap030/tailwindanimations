  ...
  <div>
    ...
    Leaving: "ease-in duration-200"
      ...
      To: "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                  ...
                  <div
                    class="grid grid-flow-col grid-cols-3 grid-rows-1 gap-4 pt-8 pb-8"
                  >
                    <!--
    Modal panel, show/hide based on modal state.
                          ...
                          <div class="mt-3 text-center sm:mt-0 sm:text-left">
                            ...
                            <div class="mt-4">
                              ...
                              <p class="ml-8 text-gray-400">
                                Get notified when the app has new updates.
                              </p>
                            </div>
                            <div class="mt-4">
                              <div class="flex items-center">
                              ...
                              <p class="ml-8 text-gray-400">
                                Get notified when the new content is provided to
                                your application.
                              </p>
                            </div>
                            <div class="mt-4">
                            ...
                            <div class="flex flex-col mt-4">
                              <label class="inline-flex items-center">
                                <input
                                  ...
                                  value="everything"
                                />
                                <span class="ml-4 leading-5 text-gray-700"
                                  >Everything</span
                                >
                              </label>
